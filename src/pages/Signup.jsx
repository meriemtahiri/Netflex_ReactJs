        ...
        <div className="fixed w-full px-4 py-24">
            <div className="max-w-[450px] h-[500px] mx-auto bg-black/75 text-white rounded">
                <div className="max-w-[320px] mx-auto py-16">
                  <h1 className="text-3xl font-bold">Singn Up</h1>
                  <form className='w-full flex flex-col py-4' onSubmit={handleSubmite}>
                    ...
                    />
                    <button className='bg-red-600 py-3 my-6 rounded font-bold hover:bg-red-700'>Sign Up</button>
                ...
                <p className='py-8'>
                  ...
                  <Link to='/login' className='hover:text-red-500'>Sign In</Link>
                </p>
